...
<div id="portfolio-ajax-single" class="clearfix">
    ...
    <div class="col_three_fifth portfolio-single-image nobottommargin">
        <img src="images/a-portfolio/full-images/trivia.png" alt="Trivia App">
    ...
    <div class="col_two_fifth portfolio-single-content col_last nobottommargin">
        ...
        ============================================= -->
        <p>A trivia game utilizing timers - using JavaScript for the logic and jQuery to manipulate HTML.</p>
        <a class="button" target=”_blank” href="https://tochwat.github.io/TriviaGame/">
            <span><i class="icon-line-link" id="project-link-icon"></i>View project</span>
        </a>
        <br>
        <a class="button" target=”_blank” href="https://github.com/tochwat/TriviaGame">
