...
<div id="portfolio-ajax-single" class="clearfix">
    ...
    <div class="col_three_fifth portfolio-single-image nobottommargin">
        <img src="images/a-portfolio/full-images/train.png" alt="Train Scheduler App">
    ...
    <div class="col_two_fifth portfolio-single-content col_last nobottommargin">
        ...
        ============================================= -->
        <p>This train scheduler application connects to a Firebase database to host train arrival and departure data.</p>
        <a class="button" target=”_blank” href="https://tochwat.github.io/Train-Scheduler/">
            <span><i class="icon-line-link" id="project-link-icon"></i>View project</span>
        </a>
        <br>
        <a class="button" target=”_blank” href="https://github.com/tochwat/Train-Scheduler">
