...
<div id="portfolio-ajax-single" class="clearfix">
    ...
    <div class="col_three_fifth portfolio-single-image nobottommargin">
        <img src="images/a-portfolio/full-images/hands.png" alt="">
    ...
    <div class="col_two_fifth portfolio-single-content col_last nobottommargin">
        ...
        ============================================= -->
        <p>A MERN full stack web app that connects local volunteers with those in need to help them complete chores and errands.</p>
        <a class="button" target=”_blank” href="https://helping-hands-2.herokuapp.com/">
            <span><i class="icon-line-link" id="project-link-icon"></i>View project</span>
        </a>
        <br>
        <a class="button" target=”_blank” href="https://github.com/ajrice1018/helping-hand">
        ...
        <ul class="portfolio-meta bottommargin">
            <li><span><i class="icon-calendar3"></i>Completed:</span> May 2019</li>
            <li><span><i class="icon-lightbulb"></i>Skills:</span> Express / Mongo / React.js</li>
        </ul>
