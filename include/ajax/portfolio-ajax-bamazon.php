...
<div id="portfolio-ajax-single" class="clearfix">
    ...
    <div class="col_three_fifth portfolio-single-image nobottommargin">
        <img src="images/a-portfolio/full-images/bamazon.png" alt="Bamazon node app">
    ...
    <div class="col_two_fifth portfolio-single-content col_last nobottommargin">
        ...
        ============================================= -->
        <p>Bamazon is a node Amazon-like storefront that uses a mySQL database. The app lets you place orders and manage inventory.</p>
        <a class="button" target=”_blank” href="https://github.com/tochwat/bamazon">
        ...
        <ul class="portfolio-meta bottommargin">
            ...
            <li><span><i class="icon-lightbulb"></i>Skills:</span> JavaScript / Node / MySQL</li>
        </ul>
