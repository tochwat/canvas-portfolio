...
<div id="portfolio-ajax-single" class="clearfix">
    ...
    <div class="col_three_fifth portfolio-single-image nobottommargin">
        <img src="images/a-portfolio/full-images/burger.png" alt="Burger app">
    ...
    <div class="col_two_fifth portfolio-single-content col_last nobottommargin">
        ...
        ============================================= -->
        <p>Eat-Da-Burger is a burger logger with MySQL, Node, Express, Handlebars and a homemade ORM.</p>
        <a class="button" target=”_blank” href="https://burger-uw200.herokuapp.com/">
            <span><i class="icon-line-link" id="project-link-icon"></i>View project</span>
        </a>
        <br>
        <a class="button" target=”_blank” href="https://github.com/tochwat/burger">
        ...
        <ul class="portfolio-meta bottommargin">
            ...
            <li><span><i class="icon-lightbulb"></i>Skills:</span> Express / MySQL / Handlebars</li>
        </ul>
