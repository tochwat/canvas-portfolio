...
<div id="portfolio-ajax-single" class="clearfix">
    ...
    <div class="col_three_fifth portfolio-single-image nobottommargin">
        <img src="images/a-portfolio/full-images/giftastic.png" alt="GifTastic App">
    ...
    <div class="col_two_fifth portfolio-single-content col_last nobottommargin">
        ...
        ============================================= -->
        <p>GifTastic is a web app that utilizes the GIPHY API to allow users to display gifs from popular movies.</p>
        <a class="button" target=”_blank” href="https://tochwat.github.io/GifTastic/">
            <span><i class="icon-line-link" id="project-link-icon"></i>View project</span>
        </a>
        <br>
        <a class="button" target=”_blank” href="https://github.com/tochwat/GifTastic">
        ...
        <ul class="portfolio-meta bottommargin">
            <li><span><i class="icon-calendar3"></i>Completed:</span> March 2019</li>
            <li><span><i class="icon-lightbulb"></i>Skills:</span> JavaScript / CSS / GIPHY API</li>
        </ul>
