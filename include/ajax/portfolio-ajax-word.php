...
<div id="portfolio-ajax-single" class="clearfix">
    ...
    <div class="col_three_fifth portfolio-single-image nobottommargin">
        <img src="images/a-portfolio/full-images/word.png" alt="">
    ...
    <div class="col_two_fifth portfolio-single-content col_last nobottommargin">
        ...
        ============================================= -->
        <p>Guess the names of the highest peaks in Washington. This guessing game uses javascript, HTML, and CSS.</p>
        <a class="button" target=”_blank” href="https://tochwat.github.io/Word-Guess-Game/">
            <span><i class="icon-line-link" id="project-link-icon"></i>View project</span>
        </a>
        <br>
        <a class="button" target=”_blank” href="https://github.com/tochwat/Word-Guess-Game">
        ...
        <ul class="portfolio-meta bottommargin">
            <li><span><i class="icon-calendar3"></i>Completed:</span> December 2018</li>
            <li><span><i class="icon-lightbulb"></i>Skills:</span> JavaScript / CSS</li>
        </ul>
